    ...
    <!-- nav header -->
        <nav>
            <div class="nav-wrapper teal lighten-1">
                <a href="#" class="brand-logo hide-on-small-only">SIO Gmina</a>
                <ul class="right">
                    <li><a href="#">Witaj ... <i class="tiny material-icons right">perm_identity</i></a></li>
                    <li><a href="#">Wyloguj <i class="tiny material-icons right">input</i></a></li>
                </ul>
            </div>
        </nav>
...
<!-- modal for fixed action button -->
    <div id="modal1" class="modal">
        ...
        <div class="modal-footer">
            <a id="exitModalButton" class="btn-floating btn-large red tooltipped">
...
<script>
    ...
    // $('#mainContent').hide().delay(4300).fadeIn(200);
    // $('#showLoader').fadeIn().delay(3700).fadeOut(200);
